        ...
        <div className='flex flex-col xl:flex-row xl:gap-[30px]'>
          ...
          <div className='w-full xl:w-[50%]'>
            <Swiper spaceBetween={30} slidesPerView={1} onSlideChange={handleSliderChange} className='xl:h-[520px] mb-12'>
              ...
              <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50% - 22px)] xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none flex sm:flex" />
            </Swiper>
          </div>
        </div>
      </div>
